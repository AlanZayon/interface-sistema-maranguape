...
import { OrganogramModal } from '@features/organograma';
      ...
      <Navbar bg="dark" variant="dark" expand="md" sticky="top" className="px-3 shadow-sm">
        <Container fluid>
                ...
                {showSuggestions && autocompleteResults.length > 0 && (
                  <ListGroup className="position-absolute w-100 mt-1 shadow" style={{ 
                    ...
                    {autocompleteResults.map((item, idx) => {
                      ...
                      const displayType = type === 'Coordenadoria' ? 'Subsetor' : type;
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            >
              <FaSitemap />
              <span className="d-none d-md-inline ms-2">Organograma</span>
            </Button>
