...
function ObservationHistoryModal({
  ...
  const handleAddObservation = async () => {
    ...
    if (observacoesregister) {
      observacoesregister.push(trimmedObservation);
      setObservacoes([...observacoes, trimmedObservation]);
    }else {
  ...
  const handleDeleteObservation = async (index) => {
    if (observacoesregister) {
       observacoesregister.splice(index, 1);
      setObservacoes([...observacoesregister]);
    }else {
