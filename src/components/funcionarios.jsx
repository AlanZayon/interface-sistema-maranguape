...
import { Container, Row, Col, Button, Modal, Form, DropdownButton, Dropdown, Collapse, Card } from 'react-bootstrap';
import { FaEdit, FaTrash, FaFile, FaAngleDown, FaAngleUp } from 'react-icons/fa'; // Ícones de edição e remoção
...
function Funcionarios({ secretaria }) {
    ...
    const filteredFuncionarios = userData
        .filter(user => user.secretaria === secretaria) // Filtro por secretaria
        .filter(user => {
        ...
        <Container>
            ...
            {Object.keys(groupedFuncionarios).map(sector => (
                ...
                >
                    ...
                    <Collapse in={expandedGroups[sector]}>
                        ...
                        {showSelectionControls && (
                            <div className="d-flex align-items-center">
                                <Form.Check
                                    ...
                                    className="me-2"
                                />
                                <Button variant="danger" onClick={handleDeleteSelected} disabled={selectedUsers.length === 0}>
                                    Apagar Selecionados
                                </Button>
                            </div>
                        )}
