    ...
    return (
        <Modal show={show} onHide={onHide} centered>
            ...
            <Modal.Body>
                ...
                >
                    <div style={{ maxHeight: '200px', overflowY: 'auto' }}>
                        <Form.Control type="text" placeholder="Pesquisar referência..." className="mx-3 my-2" />
                        ...
                        {todasReferencias.map((referencia) => (
                            <Dropdown.Item
                                ...
                                title={referencia}
                            >
                                {referencia.length > 25 ? `${referencia.substring(0, 25)}...` : referencia}
                            </Dropdown.Item>
                        ))}
                    </div>
                </DropdownButton>
                ...
                <Form.Group className="d-flex">
                    <Form.Control
                        ...
                        placeholder="Mínimo"
                        onChange={(e) =>
                            handleSalarioBrutoChange({ ...activeFilters.salarioBruto, min: e.target.value })
                        }
                        className="me-2"
                    />
                    <Form.Control
                        ...
                        placeholder="Máximo"
                        onChange={(e) =>
                            handleSalarioBrutoChange({ ...activeFilters.salarioBruto, max: e.target.value })
                        }
                    />
                </Form.Group>
                ...
                <Form.Group className="d-flex">
                    <Form.Control
                        ...
                        placeholder="Mínimo"
                        onChange={(e) =>
                            handleSalarioLiquidoChange({ ...activeFilters.salarioLiquido, min: e.target.value })
                        }
                        className="me-2"
                    />
                    <Form.Control
                        ...
                        placeholder="Máximo"
                        onChange={(e) =>
                            handleSalarioLiquidoChange({ ...activeFilters.salarioLiquido, max: e.target.value })
                        }
                    />
                </Form.Group>
                ...
                >
                    <div style={{ maxHeight: '200px', overflowY: 'auto' }}>
                        <Form.Control type="text" placeholder="Pesquisar bairro..." className="mx-3 my-2" />
